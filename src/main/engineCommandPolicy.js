...
const ALLOWED_ENGINE_COMMANDS = new Set([
  ...
  'setTransport','getTransport','foregroundEditors','syncAudioGraph','syncMidiGraph',
  'midiNode','setMetronome','setMasterOutput','resetMasterClip','syncSequencer','sequencerMidiInput',
