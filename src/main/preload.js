...
contextBridge.exposeInMainWorld('hubAPI', {
  ...
  presetsLibrary: (filter) => ipcRenderer.invoke('presets:library', filter),
  presetsRead: (filePath) => ipcRenderer.invoke('presets:read', filePath),
  presetsSources: () => ipcRenderer.invoke('presets:sources'),
  presetsCatalogue: (options) => ipcRenderer.invoke('presets:catalogue', options),
  presetsDownload: (entry) => ipcRenderer.invoke('presets:download', entry),
